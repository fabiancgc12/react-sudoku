...
export function InputButton({value}:props){
    ...
    return (
       <button
           // @ts-ignore
           style={style}
           className={`inputValueButton relative rounded sm:rounded-full w-9 h-12 sm:w-14 sm:h-14 bg-gray-900 text-slate-200 font-bold text-xl
                        after:content-[''] after:absolute after:rounded sm:after:rounded-full after:-z-10 after:top-2/4 after:left-2/4 after:w-9 after:w-12 sm:after:w-16 sm:after:h-16 after:-translate-y-2/4 after:-translate-x-2/4
                        hover:bg-gray-600`}
           onClick={onClick}
       >
           {value}
